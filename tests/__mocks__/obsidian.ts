...
export class Plugin {
  ...
  addSettingTab(): this { return this; }
  registerEditorExtension(): this { return this; }
  ...
  registerEvent(): this { return this; }
  registerDomEvent(): this { return this; }
...
export function createTestApp(config: {
  ...
  if (config.activeFile) {
    const activeFile = typeof config.activeFile === 'string'
